...
class WorldbookConversationControl(QObject):
    ...
    def freeze_turn_snapshot(
        ...
        *,
        ...
        from runtime.worldbook import freeze_turn_snapshot
        return freeze_turn_snapshot(self._chat, self._character, self._catalog, self._config,
            self._chat_manager, append_user_message=append_user_message)
