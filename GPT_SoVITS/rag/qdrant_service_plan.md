...
- `character_thoughts: list[PointRecord[CharacterThoughtDocument]]`
...
> **历史文档，已被替代：** 本文保留最初 service 讨论记录，其中的 `SeasonId/season_id(s)` 已不再有效。当前实现以 `docs/design/worldbook-management.md`、ADR-0024 以及运行时模型为准。
