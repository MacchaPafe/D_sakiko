2025.7.8
增加OpenAI GPT以及Google Gemini API选择

2025.6.23
1.功能更新：现在可以使用鼠标点击历史文本来播放对应音频了
2.添加了API_Key.txt文件，大家可以在该文件中填入自己的Deepseek API密钥，程序会自动识别。
关于API的事情，是这样的：
首先当然是感谢大伙对这个项目的支持，我看到我的API使用量与日俱增，真的是非常开心，说明喜欢或对我的作品感兴趣的大家是越来越多的！但是同时，由于UP还是一个苦逼研究牲，API的费用上确实有些困难...当然，这个文件大家不填的话就还是用UP自己的key，也完全没问题的，我还是会继续充值，继续维护数字小祥项目，毕竟是我自己的心血，肯定不会放弃
