...
* Bert-base-Chinese NLP中文预训练模型及OCEMOTION中文七种情感分类数据集，将bert微调为七分类文本情感识别模型 bert-base-Chinese：https://huggingface.co/google-bert/bert-base-chinese
...
## 2025.12.9 v2.4
* 增加启动配置程序，可以设置一些影响语音生成速度和质量的启动参数。
