...
2.  **运行安装程序**
    ...
    *   **解决方法如下**：
        ...
        2.  向下滚动页面，直到您看到“‘安装程序.command’已阻止使用，因为其来自不明开发者”的提示。
            ![image-20260111210203644](./MacOS 软件包安装指南.assets/image-20260111210203644.png)
...
4.  **耐心等待安装**
    ...
    ![截屏2026-01-11 21.08.50](./MacOS 软件包安装指南.assets/截屏2026-01-11 21.08.50.png)
...
3.  **问：安装过程中弹窗说“需要使用命令行开发者工具”，让我安装，这是什么？**
    **答**：这是苹果提供的一个官方开发工具包。我们的程序在安装时需要用到其中的一些工具。
    ![image-20260111211651803](./MacOS 软件包安装指南.assets/image-20260111211651803.png)
